...
func (r *testRender) Style() *style.Computed {
...
func (d *testDocument) NavigateFocus(dir dom.Direction) bool { return false }
func (d *testDocument) MoveCaret(dir dom.Direction) bool     { return false }
