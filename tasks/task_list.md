...
| TSK-067 | Implement `extras/flight` Stack Navigation | In Progress | `tasks/TSK-067-flight-navigation.md` |
| TSK-068 | Implement `extras/wind` Data Fetching | Pending | `tasks/TSK-068-wind-data-fetching.md` |
