...
| TSK-042 | Refactor Engine to use Pipeline Decorator and Inline TraceContext | Pending | `tasks/TSK-042-profiler-pipeline-decorator.md` |
| TSK-043 | Implement DevTools Profiler Endpoints and Flamechart UI | Pending | `tasks/TSK-043-devtools-flamechart-ui.md` |
